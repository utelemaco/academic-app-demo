...
public class AppNameApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(AppNameApp.class);

    private final Environment env;

    public AppNameApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AppNameApp.class);
